...
dx_console_menu_t demo_console_menus[]  = {
	{1, "start", "start servers ..", demo_start_menu_handler},
	...
	{2, "server", "do something with server ..",  demo_start_menu_handler},
	...
	{3, "client", "do something with client ..",  demo_start_menu_handler},
